...
- **Cumulative downloads by release age** overlays versions by days since publication, useful for adoption curves. Use the chart control to cap displayed release age days and **Reset view** to restore the full range.
